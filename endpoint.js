...
const getFacts = async () =>{
    ...
    const cont1=document.querySelector(".div1");
    ...
    `;
    div1.appendChild(cont1j);

    // document.getElementsByClassName('div1').addEventListener('click', function() {
    //     var contentBox = document.getElementsByClassName('cont1j');
    ...
    const targetDiv = document.getElementById("cont1j");
